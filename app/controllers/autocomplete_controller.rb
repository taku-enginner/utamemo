...
class AutocompleteController < ApplicationController
  ...
  def songs
    ...
    return render json: { error: 'APIリクエストが失敗しました' }, status: :internal_server_error if results.nil?
  ...
  def artists
    ...
    return render json: { error: 'APIリクエストが失敗しました' }, status: :internal_server_error unless results
